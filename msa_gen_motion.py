...
resume_pth = "Experiments/MSA_VAEv6_phase2_t2m_272_phase1_alpha0_t5_trans662048/net_last.pth"
...
def main():
    try:
        ...
        base_model = LLaMAHF(config, num_diffusion_head_layers, latent_dim, device)
