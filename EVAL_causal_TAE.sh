...
# python eval_causal_TAE.py --resume-pth ../Experiments/explorations/representation_experiments/TAE_GAN_Loss_/tae_gan_v1_t2m_272_op/net_best_mpjpe.pth  # FID. 0.4960, mpjpe. 22.13312 (mm)
