...
def parse_args():
    ...
    parser.add_argument("--poses", type=str, default="./demo_output/Representation_272")
    parser.add_argument("--fps", type=int, default=60)
    parser.add_argument("--output", type=str, default="./demo_output/Representation_272_bhv")
