...
RAG_CKPT=${RAG_CKPT:-Experiments/MotionStreamer_t2m_272_msa_rag_t5_trans662048_latent_retr_6layer_top3_ddpm/net_Iter100000.pth}
...
python eval_msa_t2m_rag_mca.py \
