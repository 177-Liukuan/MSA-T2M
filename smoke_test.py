...
# Check train_t2m_msa.py for critical patterns
with open('train_t2m_msa.py', 'r') as f:
    code = f.read()
    checks = [
...
with open('train_t2m_baseline_clip.py', 'r') as f:
    code = f.read()
...
print("     python get_text_latent_clip.py")
print("")
print("  3. Train MSA-VAE model:")
print("     bash TRAIN_t2m_msa.sh 4 <MSA_EXP_NAME> <RUN_NAME>")
print("")
print("  4. Train Baseline (TAE+CLIP) for comparison:")
print("     bash TRAIN_t2m_baseline_clip.sh 4 <TAE_LATENT_DIR> <RUN_NAME>")
print("")
