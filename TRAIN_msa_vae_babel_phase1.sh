#!/usr/bin/env bash
# BABEL sparse-global MSA-VAE Phase 1: freeze the approved joint Causal TAE.
# This workflow is for reconstruction/local-alignment validation, not T2M.
...
# This is the identity of the approved joint HumanML3D+BABEL Causal TAE.
# Override both CNN_CKPT and CNN_CKPT_SHA256 together for a replacement artifact.
...
EXP_NAME=${EXP_NAME:-MSA_VAEv6_babel_sparse_global_phase1_t5_662048}

echo "========== BABEL sparse-global MSA-VAE Phase 1 =========="
echo "GPUs            : $NUM_GPUS"
echo "Batch per GPU   : $BATCH_SIZE"
echo "Causal TAE      : $CNN_CKPT"
