...
# Usage:
#   bash EVAL_t2m_rag_t5_rf.sh [NUM_GPUS]
...
echo "=========================================="
echo "MSA-T2M RAG Evaluation (Rectified Flow)"
echo "=========================================="
...
python -m explorations.rectified_flow.eval_msa_t2m_rag_t5_rf \
  ...
  --exp-name MotionStreamer_t2m_272_msa_rag_t5_trans662048_rf_100000Iter_addEMA \
  --reference_end_latent_path humanml3d_272/t2m_latents_msa_vae/MSA_VAEv6_phase2_t2m_272_phase1_alpha0_t5_trans662048/reference_end_latent_msa_vae_t2m_272.npy \
  --retrieval_topk 3 \
